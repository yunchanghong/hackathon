...
public class DES {
    ...
    /**
     * Change the string into the bit array
     *
     * @param key The input string
     * @return Bit array (its length % 64 = 0)
     */
    public static List<int[]> getKeyBytes(String key) {
    ...
    /**
     * Change the string (its length <= 4) into the bit array
     *
     * @param str The input string
     * @return bit array (its length = 64)
     */
    ...
    private static String bt64ToHex(int[] encByte) {
        StringBuilder hex = new StringBuilder();
        for (int i = 0; i < 16; i++) {
            StringBuilder bt = new StringBuilder();
            for (int j = 0; j < 4; j++) {
                bt.append(encByte[i * 4 + j]);
            }
    ...
    */
    ...
    public static String bt64ToHex(String[] byteData){
        String hex = "";
        for(int i = 0;i<16;i++){
            String bt = "";
            for(int j=0;j<4;j++){
    ...
    */
    ...
    public static int[] enc(int[] dataByte, int[] keyByte){
        List<int[]> keys = generateKeys(keyByte);
    ...
    public static byte[] xor(int[] js, int[] key) {
        byte[] xorByte = new byte[js.length];
        for (int i = 0; i < js.length; i++) {
            xorByte[i] = (byte) (js[i] ^ key[i]);
        }
        return xorByte;
    }
    
    public static int[] sBoxPermute(byte[] bs) {
        ...
        for (int m = 0; m < 8; m++) {
            int i = 0, j = 0;
            i = bs[m * 6 + 0] * 2 + bs[m * 6 + 5];
            j = bs[m * 6 + 1] * 8 + bs[m * 6 + 2] * 4 + bs[m * 6 + 3] * 2 + bs[m * 6 + 4];
            switch (m) {
                case 0:
    ...
    public static List<int[]> generateKeys(int[] keyByte) {
        int[] key = new int[56];
        ...
        for (int i = 0; i < 16; i++) {
            ...
            System.arraycopy(tempKey, 0, keys.get(i), 0, 48);
        }
        return keys;
    }
    ...
    public static void main(String[] args) {
        String data = "230450508";
        String firstKey = "1";
        String secondKey = "2";
        String thirdKey = "3";
        String encryptedData = strEnc(data, firstKey, secondKey, thirdKey);
        System.out.println("Encrypted Data: " + encryptedData);
//        String decryptedData = strDec(encryptedData, firstKey, secondKey, thirdKey);
        String data2 = "";
        String decryptedData = strDec(data2, firstKey, secondKey, thirdKey);
        System.out.println("decryptedData Data: " + decryptedData);
